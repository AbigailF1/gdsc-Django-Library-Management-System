...
urlpatterns = [
    ...
    path('adminlogin', LoginView.as_view(template_name='librarySystem/adminlogin.html')),
    path('studentlogin', LoginView.as_view(template_name='librarySystem/studentlogin.html')),

    path('logout', LogoutView.as_view(template_name='librarySystem/index.html')),
