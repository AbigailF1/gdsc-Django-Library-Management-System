...
urlpatterns = [
   ...
   path('adminLoggedin/', user_view.adminafterlogin_view, name= 'admin_after_login'),
   path('adminsignup/', user_view.adminsignup_view, name= 'admin_signup'),
   path('adminLogin/', user_view.adminlogin_view, name= 'admin_login'),
   path('adminNotVerified/', user_view.adminnotverified_view, name= 'admin_not_verified'),
